...
const FloatingControlPanel: React.FC<FloatingControlPanelProps> = ({
  ...
  const [layerVisible, setLayerVisible] =
    useState<{ [key in keyof LayerOpacityType]: boolean }>(layerVisibility);
  const [isDragging, setIsDragging] = useState(false);
  const [position, setPosition] = useState(initialPosition || { x: 0, y: 0 });
  const [useDefaultPosition, setUseDefaultPosition] =
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    aria-label={
                      isEditMode ? "Exit Edit Mode" : "Edit Landmarks"
                    }
                  >
                    <Edit2 size={18} />
                  </button>
      ...
      {activeControl === "image" && (
        ...
        >
          <div className={classes.panelHeader}>
            ...
            <button className={classes.closeButton} onClick={closeControls}>
              <X size={16} />
            </button>
          </div>
          <div
            className={`${classes.opacityControls} ${classes.floatingPanelContent}`}
          >
            <div className={classes.opacitySlider}>
              ...
              <input
                ...
                onChange={(e) =>
                  onImageControlChange("brightness", parseInt(e.target.value))
                }
            ...
            <div className={classes.opacitySlider}>
              ...
              <input
                ...
                onChange={(e) =>
                  onImageControlChange("contrast", parseInt(e.target.value))
                }
                className={classes.slider}
              />
            </div>
          ...
          >
            <div className={classes.opacitySlider}>
              <div className={classes.sliderLabel}>
                ...
                <div className={classes.sliderControls}>
                  <span
                    className={`${classes.sliderValue} ${!layerVisible.landmarks ? classes.disabled : ""}`}
                  >
              ...
              <input
                ...
                onChange={(e) =>
                  onLayerOpacityChange("landmarks", parseInt(e.target.value))
                }
            ...
            <div className={classes.opacitySlider}>
              <div className={classes.sliderLabel}>
                ...
                <div className={classes.sliderControls}>
                  <span
                    className={`${classes.sliderValue} ${!layerVisible.measurements ? classes.disabled : ""}`}
                  >
              ...
              <input
                ...
                onChange={(e) =>
                  onLayerOpacityChange("measurements", parseInt(e.target.value))
                }
            ...
            <div className={classes.opacitySlider}>
              <div className={classes.sliderLabel}>
                ...
                <div className={classes.sliderControls}>
                  <span
                    className={`${classes.sliderValue} ${!layerVisible.tracing ? classes.disabled : ""}`}
                  >
              ...
              <input
                ...
                onChange={(e) =>
                  onLayerOpacityChange("tracing", parseInt(e.target.value))
                }
            ...
            <div className={classes.opacitySlider}>
              <div className={classes.sliderLabel}>
                ...
                <div className={classes.sliderControls}>
                  <span
                    className={`${classes.sliderValue} ${!layerVisible.analysisLine ? classes.disabled : ""}`}
                  >
              ...
              <input
                ...
                onChange={(e) =>
                  onLayerOpacityChange("analysisLine", parseInt(e.target.value))
                }
            ...
            <button className={classes.resetButton} onClick={onResetLayers}>
              <RotateCcw size={14} />
